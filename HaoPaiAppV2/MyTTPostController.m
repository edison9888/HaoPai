...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation MyTTPostController
	...
	if (!_navigationHeader) {
        _navigationHeader = [[UIImageView alloc] 
                             initWithImage:[TTIMAGE(@"bundle://menu-top-bg.png")
                                            ...
                                            topCapHeight:44]];
        _navigationHeader.userInteractionEnabled = YES;
...
- (void)loadView {
    ...
    _textView.frame = CGRectMake(0, 44, 320, 200);
    ...
    [_registerButton setImage:TTIMAGE(@"bundle://btn-submit.png") forState:UIControlStateNormal];
    [_registerButton setImage:TTIMAGE(@"bundle://btn-submit-on.png") forState:UIControlStateNormal];
    [_registerButton addTarget:self action:@selector(post) forControlEvents:UIControlEventTouchUpInside];
	_registerButton.frame = CGRectMake((320-68), (44-38.5)/2, 60, 36);
	[self.navigationHeader addSubview:_registerButton];
