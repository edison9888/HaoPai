...
-(id) initWithFrame:(CGRect)aFrame style:(TBKTabBarStyle)aStyle {
   ...
   UIImageView * _back =  [[UIImageView alloc] initWithImage:
     [TTIMAGE(@"bundle://toolbar-bg.png") stretchableImageWithLeftCapWidth:3 topCapHeight:20]];
    
    _back.frame = CGRectMake(0, -4, aFrame.size.width, 62);
