...
-(id) initWithImageName:(NSString *)anImageName selectedImageName:(NSString *)aSelectedImageName style:(TBKTabBarItemSelectionStyle)aStyle preRendered:(BOOL)isPreRendered {
	...
	if (isPreRendered) {
		...
		self.selectedTabImage = [UIImage imageNamed:[NSString stringWithFormat:@"%@-b",self.imageName]];//[UIImage imageNamed:aSelectedImageName];
	    self.imageView.contentMode = UIViewContentModeScaleToFill;		
	
	} else {
		self.tabImage = [UIImage imageNamed:self.imageName];
		self.selectedTabImage = [UIImage imageNamed:[NSString stringWithFormat:@"%@-b",self.imageName]];//[[UIImage imageNamed:self.imageName] selectedTabBarImage];
